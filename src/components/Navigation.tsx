        ...
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              ...
              className="bg-[#1b78fc] text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-[#0d5fd9] transition-colors"
            >
              Book Now
            </button>
          </div>
        ...
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-4 py-6 space-y-4">
            ...
            <div className="pt-4 border-t border-gray-200 space-y-3">
              ...
              <button
                onClick={() => scrollToSection('contact')}
                className="w-full bg-[#1b78fc] text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-[#0d5fd9] transition-colors"
              >
                Book Now
              </button>
            </div>
