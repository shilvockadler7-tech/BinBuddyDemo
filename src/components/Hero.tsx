  ...
  return (
    <section id="home" className="relative pt-20 pb-8 sm:pt-32 sm:pb-20 lg:pt-40 lg:pb-32 bg-white overflow-hidden">
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 right-0 w-64 h-64 sm:w-96 sm:h-96 bg-[#1b78fc] rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 sm:w-96 sm:h-96 bg-[#1b78fc] rounded-full filter blur-3xl"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 sm:space-y-8">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
              Reliable{' '}
              <span className="text-[#1b78fc]">Hauling & Bin Services</span> in Florida
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <button
                ...
                className="group bg-[#1b78fc] text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-semibold text-base sm:text-lg hover:bg-[#0d5fd9] transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl"
              >
              ...
              <button
                onClick={() => scrollToSection('contact')}
                className="group bg-white text-gray-900 px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-semibold text-base sm:text-lg border-2 border-gray-300 hover:border-[#1b78fc] transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl"
              >
